...
def listener():
    rospy.Subscriber("/RequestFromInterfaceToCNN", String, callbackTreatRequest)
...
#            print "Shutting down"          
	...
	global request;
        ...
        #colorSpace = 11   # RGB
        images = []
	pub = rospy.Publisher('/LabelFromManagerToInterface', String, queue_size=10) 
	listener()
        while (100):
	...
	#	#c = 0;
		#while c < 1:
		print result
		pub.publish(result) # ----< I dont know if this is correct
		  #r.sleep()
		#  c = c + 1
		mutex.release()	    
...
def experimentsNAO():
    ...
    testImageDirectory = "../../Database/testImage/"    
